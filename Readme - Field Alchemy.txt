...
--Change log--
2.2.2:
- Activating the mortar and pestle (or using the hotkey) now opens the crafting menu without any animations when the player is in a location with the keyword LocTypeInn. This is to stop waiter NPCs from talking to the player when they shouldn't.
- Changed the method of closing the inventory after equipping the mortar and pestle. Inventory menu should also close automatically now when using a gamepad.
